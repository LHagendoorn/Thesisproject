...
import cifar10_ACOLPL_VGG16_noACOLst1 as cifar10
...
def train(fileappend = '.bin', steps=50000, continueTraining = False, part1 = False, filename = ''):
  ...
  with tf.Graph().as_default():        
    ...
    loss, balance, affinity, coact = cifar10.loss(smStacked, stackedClusts, softmaxMat, labels, superLabels,contTraining=continueTraining)
